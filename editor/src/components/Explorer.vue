<template>
  <div class="explorer flex flex--column">
    <div class="side-title flex flex--row flex--space-between">
      ...
      <button v-show="current.id" class="side-title__button side-title__button--close button" @click="toggleExplorer(false)" v-title="'关闭资源管理器'">
...
export default {
  ...
  created() {
    this.toggleExplorer(true); // 默认显示资源管理器
    this.$watch(
