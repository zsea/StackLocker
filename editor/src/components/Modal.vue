...
import PictureBedModal from './modals/PictureBedModal';
...
// 自定义
import InputPasswordModal from './modals/InputPassword';
import ChangePasswordModal from './modals/ChangePassword';
import ImageGithubModal from './modals/providers/ImagePlatform/ImageGithubModal';
